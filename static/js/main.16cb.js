...
`;class gi extends a.a{componentDidMount(){this.observer=new IntersectionObserver(this.props.loadMore),this.observer.observe(this.target)}componentWillUnmount(){this.observer.unobserve(this.target)}render({loadMore:e,isLoading:t}){return Object(a.c)(ui,{onClick:e,innerRef:e=>this.target=e},t?Object(a.c)(ci,null):Object(a.c)("strong",null,"Load More..."))}}var di=gi,Mi=i(57),Ii=i.n(Mi),yi=i(58),ji=i.n(yi),pi=i(59),Ni=i.n(pi),hi=i(60),Li=i.n(hi),bi=i(61),Di=i.n(bi);const xi=Object(Ae["a"])(fe)`
  opacity: 0;
  margin: auto;
  display: block;
`,Ai=Ae["a"].img`
...
//# sourceMappingURL=main.16cb.js.map