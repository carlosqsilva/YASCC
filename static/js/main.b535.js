...
`,Se=Te["a"].input`
  ...
  padding: 0 1em;
  width: 100%;
`;class we extends i.a{constructor(...e){super(...e),this.state={value:""},this.handleChange=(e=>{this.setState({value:e.target.value})}),this.handleSubmit=(e=>{e.preventDefault(),this.props.searchSongs(this.state.value),this.props.history.push("/search")})}render(e,{value:t}){return Object(i.c)(ve,{onSubmit:this.handleSubmit},Object(i.c)(Se,{placeholder:"Search...",value:t,onChange:this.handleChange}))}}const ze={searchSongs:ye};var fe=Object(n.b)(null,ze)(Object(Ae.a)(we));const Ce=Te["a"].img.attrs({alt:"",width:e=>e.size,height:e=>e.size})`
  align-self: center;
