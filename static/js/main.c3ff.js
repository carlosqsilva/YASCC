...
`;class yt extends a.a{constructor(...e){super(...e),this.state={active:""},this.changeRoute=(e=>{this.props.history.push(e)}),this.active=(e=>{this.setState({active:e},()=>{this.changeRoute("/")})}),this.onChange=(e=>{this.props.setFilter(e.target.value)}),this.onTag=(({target:{name:e}})=>{this.props.setTag(e),this.active(e)}),this.onGenre=(({target:{name:e}})=>{this.props.setGenre(e),this.active(e)})}render({sidebarVisible:e,qtd:t,innerRef:i,events:n},{active:o}){return Object(a.c)(st,lt({visible:e,innerRef:i},n),Object(a.c)(ut,{to:"/recent"},Object(a.c)(fe,{size:20,src:nt.a}),Object(a.c)(gt,null,"Recent Played")),Object(a.c)(ut,{to:"/playlist"},Object(a.c)(fe,{size:20,src:it.a}),Object(a.c)(gt,null,"Playlist"),Object(a.c)(Mt,null,t)),Object(a.c)(ct,{horizontal:!0},Object(a.c)(fe,{size:20,src:rt.a}),Object(a.c)(et,{options:Ve,onChange:this.onChange})),Object(a.c)(ct,null,Object(a.c)(dt,null,"Popular Tags"),Je.map((e,t)=>Object(a.c)(It,{key:t,name:e.value,active:o===e.value,onClick:this.onTag},e.label))),Object(a.c)(ct,null,Object(a.c)(dt,null,"Music Genres"),_e.map((e,t)=>Object(a.c)(It,{key:t,name:e.value,active:o===e.value,onClick:this.onGenre},e.label))))}}const jt=({root:{sidebarVisible:e},playlist:{qtd:t}})=>({sidebarVisible:e,qtd:t}),pt={setFilter:de,setGenre:ue,setTag:ge};var Nt=Object(Oe.a)(Object(n.b)(jt,pt)(yt));function ht(){return(ht=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var i=arguments[t];for(var a in i)Object.prototype.hasOwnProperty.call(i,a)&&(e[a]=i[a])}return e}).apply(this,arguments)}class Lt extends a.a{constructor(...e){super(...e),this.open=!1,this.startX=0,this.diffX=0,this.handleTouchEnd=(()=>{this.diffX>.3*window.innerWidth&&(this.toggleDrawer(),this.diffX=0)}),this.handleTouchStart=(e=>{this.startX=e.targetTouches[0].clientX}),this.handleTouchMove=(e=>{const{clientX:t}=e.targetTouches[0];this.diffX=Math.abs(t-this.startX)}),this.handleDrawer=(e=>{this.drawer=e}),this.handleOverlay=(e=>{this.overlay=e}),this.toggleDrawer=(()=>{this.open,this.drawer.classList.toggle("active"),this.overlay.classList.toggle("active"),this.open=!this.open})}componentDidUpdate(e){e.sidebarVisible!==this.props.sidebarVisible&&this.toggleDrawer()}render(){const e={onTouchStart:this.handleTouchStart,onTouchMove:this.handleTouchMove,onTouchEnd:this.handleTouchEnd};return Object(a.c)("aside",null,Object(a.c)(Nt,{innerRef:this.handleDrawer,events:e}),Object(a.c)(bt,ht({onClick:this.toggleDrawer,innerRef:this.handleOverlay},e)))}}const bt=Ae["a"].div`
  position: fixed;
  top: 0px;
  left: 0px;
  width: 20px;
...
`,_t=e=>{let{toggleMute:t,muted:i}=e,n=Bt(e,["toggleMute","muted"]);return Object(a.c)(Jt,null,Object(a.c)(ke,{onClick:t},Object(a.c)(fe,{src:i?Ht.a:Gt.a,size:20})),Object(a.c)(Zt,Wt({full:!0,step:"0.05",value:"1",max:"1"},n)))},Xt=({player:{muted:e}})=>({muted:e});var Ft=Object(n.b)(Xt)(_t);function $t(e,t){if(null==e)return{};var i,a,n=Kt(e,t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);for(a=0;a<o.length;a++)i=o[a],t.indexOf(i)>=0||Object.prototype.propertyIsEnumerable.call(e,i)&&(n[i]=e[i])}return n}function Kt(e,t){if(null==e)return{};var i,a,n={},o=Object.keys(e);for(a=0;a<o.length;a++)i=o[a],t.indexOf(i)>=0||(n[i]=e[i]);return n}const qt=Ae["a"].div`
  flex: 1;
  display: flex;
  padding: 0 0.5rem;
...
`;var ti=e=>{let{title:t,duration:i}=e,n=$t(e,["title","duration"]);return Object(a.c)(qt,null,Object(a.c)(ei,null,Object(a.c)("span",null,t),Object(a.c)("span",null,i)),Object(a.c)(Zt,n))};const ii=Ae["a"].div`
  padding-left: var(--sidebarSpace);
  background: var(--primary);
  backface-visibility: hidden;
  position: fixed;
...
`;class ui extends a.a{componentDidMount(){this.observer=new IntersectionObserver(this.props.loadMore),this.observer.observe(this.target)}componentWillUnmount(){this.observer.unobserve(this.target)}render({loadMore:e,isLoading:t}){return Object(a.c)(ci,{onClick:e,innerRef:e=>this.target=e},t?Object(a.c)(si,null):Object(a.c)("strong",null,"Load More..."))}}var gi=ui,di=i(57),Mi=i.n(di),Ii=i(58),yi=i.n(Ii),ji=i(59),pi=i.n(ji),Ni=i(60),hi=i.n(Ni),Li=i(61),bi=i.n(Li);const Di=fe.extend`
  opacity: 0;
  margin: auto;
  display: block;
`,xi=Ae["a"].img`
...
`,zi=e=>{const t=e?hi.a:bi.a,i=e?"Remove from Playlist":"Add to Playlist";return({song:e,play:n,playlistAction:o,active:r})=>Object(a.c)(Ai,{onClick:n,className:r?"active":""},Object(a.c)(xi,{onClick:o,title:i,src:t,id:"action",size:24}),Object(a.c)(mi,{style:{background:`url(${e.artwork})`}},Object(a.c)(Di,{src:r?pi.a:Mi.a,id:"play",size:40})),Object(a.c)(Ti,null,Object(a.c)(Oi,null,e.user),Object(a.c)(vi,{title:e.title},e.title),Object(a.c)(Si,null,Object(a.c)(Ci,{flex:!0},e.duration),Object(a.c)(fe,{src:yi.a,size:12}),Object(a.c)(Ci,{title:`${e.likesCount} likes`},e.likesCountMin))))},fi=Ae["a"].div`
  width: 100%;
  height: 100%;
  padding: 10px;
  overflow-y: scroll;
...
`,Ei=({InnerComponent:e,infinite:t,fromPlaylist:i})=>{const n=zi(i);return class extends a.a{constructor(...e){super(...e),this.playSong=(e=>()=>{this.props.playSong(e,this.props.location.pathname)}),this.playlistAction=(e=>t=>{t||(t=window.event),t.stopPropagation&&t.stopPropagation(),this.props.playlistAction(e)})}componentDidMount(){const{onMounted:e,ready:t}=this.props;e&&t&&e()}render({loadMore:i,playlist:o,loading:r,active:l,ready:s,location:c}){return"/"===c.pathname||s?Object(a.c)(fi,null,e&&Object(a.c)(e,null),Object(a.c)(wi,null,o.map((e,t)=>Object(a.c)(n,{song:e,active:l===e.id,playlistAction:this.playlistAction(e),play:this.playSong(t),key:e.id}))),t&&Object(a.c)(gi,{isLoading:r,loadMore:i})):Object(a.c)(li.a,{to:"/"})}}},ki=Ei({infinite:!0}),Pi=({player:{active:e},playlist:{playlist:t,loading:i}})=>({playlist:t,active:e,loading:i}),Yi={loadMore:Me,playSong:re,playlistAction:je};var Ui=Object(n.b)(Pi,Yi)(ki);const Zi=Ei({}),Qi=({playlist:{recent:e},player:{active:t},root:{ready:i}})=>({playlist:e,active:t,ready:i}),Hi={playSong:re,playlistAction:je,onMounted:Ne};var Ri=Object(n.b)(Qi,Hi)(Zi);const Gi=Ei({infinite:!0}),Wi=({playlist:{search:e,loading:t},player:{active:i},root:{ready:a}})=>({playlist:e,active:i,loading:t,ready:a}),Bi={loadMore:ye,playSong:re,playlistAction:je};var Vi=Object(n.b)(Wi,Bi)(Gi);const Ji=Ei({fromPlaylist:!0}),_i=({playlist:{user:e},player:{active:t},root:{ready:i}})=>({playlist:e,active:t,ready:i}),Xi={playSong:re,playlistAction:pe};var Fi=Object(n.b)(_i,Xi)(Ji);const $i=Ae["a"].div`
  height: 100vh;
  max-width: 100vw;
  padding-top: 50px;
  overflow: hidden;
